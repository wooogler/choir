...
Knowledge Repository: ${URLtoGithubORWebsite}`
    ...
    return result || `That's interesting, *${userName}*! Is there anything specific about ${organizationName} documents I can help you with, or perhaps an update you'd like to suggest?`;
